...
addon_info = {
	...
	"addon_name" : "myFavoriteTopics",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on to be shown on installation and add-on information.
	"addon_summary" : "My favorite topics",
	# Add-on description
...
pythonSources = [os.path.join("addon", "globalPlugins", "myFavoriteTopics", "*.py"), os.path.join ("addon", "installTasks.py")]
